...
export default function Home() {
  ...
  const [texts, setTexts] = useState<any>({
      ...
      exp: [
        {
          ...
          head: textsToSave?.["servicesDataexp0head"] || "CNC Cutting Table",
          body: textsToSave?.["servicesDataexp0body"] || "Our CNC cutting table provides highly accurate and efficient glass cutting, delivering custom shapes with minimal waste for any design requirement."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          ...
          head: textsToSave?.["servicesDataexp1head"] || "Washing",
          body: textsToSave?.["servicesDataexp1body"] || "Our automated glass washing process effectively removes dirt, grease, and contaminants, ensuring spotless, clear glass ready for further processing or installation."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          ...
          body: textsToSave?.["servicesDataexp2body"] || "Our tempering process strengthens glass by heating and rapidly cooling it, enhancing its durability and impact resistance, ideal for safety-critical applications."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          ...
          head: textsToSave?.["servicesDataexp3head"] || "Drilling / Dulling",
          body: textsToSave?.["servicesDataexp3body"] || "We offer precise drilling for various hole sizes and locations, along with dulling to smooth sharp edges, ensuring safety and a clean, polished finish."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          img: <img className="w-full h-full rounded-md" src="/LAMINATING.jpg"/>,
          ...
          body: textsToSave?.["servicesDataexp0body"] || "We laminate multiple glass layers with an interlayer, creating shatter-resistant, soundproof, and durable glass, perfect for safety and privacy applications."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          img: <img className="w-full h-full rounded-md" src="/DOUBLE GLAZING..jpg"/>,
        ...
        },
        {
          ...
          img: <img className="w-full h-full rounded-md" src="/TEMPERING3.jpg"/>,
          // img: <svg className='w-5' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#fff"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M22 12v8h-1v-8zm-4 8V7h-1v13zm-4 0V2h-1v18zm-4 0V7H9v13zm-5 0h1v-8H5zM1 1v22h22v-1H2V1z"></path><path fill="none" d="M0 0h24v24H0z"></path></g></svg>,
          head: textsToSave?.["servicesDataexp2head"] || "IGU",
          body: textsToSave?.["servicesDataexp2body"] || "Our insulated glass units (IGUs) provide excellent thermal and acoustic insulation, helping to enhance energy efficiency and reduce costs in residential and commercial buildings."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          img: <img className="w-full h-full rounded-md" src="/DULLING .jpg"/>,
          // img: <svg className='w-5' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M16.5 11.3308C16.5 13.1552 14.7029 15 12 15C9.29713 15 7.5 13.1552 7.5 11.3308V7.5H16.5V11.3308ZM17.9502 12C17.7751 13.1667 17.1485 14.2115 16.2263 15H18V16.5L12 16.5L6 16.5V15H7.77371C6.67832 14.0635 6 12.7654 6 11.3308V6H18C19.6569 6 21 7.34315 21 9C21 10.6569 19.6569 12 18 12H17.9502ZM18 7.5V10.5C18.8284 10.5 19.5 9.82843 19.5 9C19.5 8.17157 18.8284 7.5 18 7.5ZM7.5 18.75L7.5 17.25L16.5 17.25V18.75L7.5 18.75Z" fill="#fff"></path> </g></svg>,
          head: textsToSave?.["servicesDataexp3head"] || "WaterJet Cutting",
          body: textsToSave?.["servicesDataexp3body"] || "Using high-pressure water jets, we achieve precise and complex cuts on glass without heat, ideal for detailed designs and custom applications."
        },
        {
          img2: ["/LAMINATING.jpg", "/TEMPERING3.jpg"],
          img: <img className="w-full h-full rounded-md" src="/DULLING .jpg"/>,
          // img: <svg className='w-5' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M16.5 11.3308C16.5 13.1552 14.7029 15 12 15C9.29713 15 7.5 13.1552 7.5 11.3308V7.5H16.5V11.3308ZM17.9502 12C17.7751 13.1667 17.1485 14.2115 16.2263 15H18V16.5L12 16.5L6 16.5V15H7.77371C6.67832 14.0635 6 12.7654 6 11.3308V6H18C19.6569 6 21 7.34315 21 9C21 10.6569 19.6569 12 18 12H17.9502ZM18 7.5V10.5C18.8284 10.5 19.5 9.82843 19.5 9C19.5 8.17157 18.8284 7.5 18 7.5ZM7.5 18.75L7.5 17.25L16.5 17.25V18.75L7.5 18.75Z" fill="#fff"></path> </g></svg>,
          head: textsToSave?.["servicesDataexp3head"] || "Robotic Glass Carrier",
          body: textsToSave?.["servicesDataexp3body"] || "Our robotic glass carriers automate the handling and transportation of glass panels, reducing risks and ensuring efficient, safe movement throughout production."
        }
      ]
    },
    consultantData: {
    ...
    caseData: {
      head: textsToSave?.["caseDatahead"] || "Our Products",
      body: textsToSave?.["caseDatabody"] || "At Technoglass Industries Limited, we turn ideas into reality with innovative glass solutions. Explore our case studies to see how we deliver excellence and value in every project.",
      worksData: [
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0001.jpg", id: 1, content: "Curtain wall" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0002.jpg", id: 2, content: "Curtain wall" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0003.jpg", id: 3, content: "Glass Staircase with Aluminuim Railings & Accesories" },
        { img: imagesToSave["caseDataworksData0img"] || "/image copy 7.png", id: 1, content: "MMIA Ikeja Lagos" },
        { img: imagesToSave["caseDataworksData1img"] || "/image copy 8.png", id: 2, content: "Mega Chicken Complex, Amuwo Odofin, Lagos" },
        { img: imagesToSave["caseDataworksData2img"] || "/image copy 9.png", id: 3, content: "Black Diamond Apartments, VI Lagos" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0004.jpg", id: 1, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0005.jpg", id: 2, content: "Curtain wall" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0006.jpg", id: 3, content: "Mirrors" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0007.jpg", id: 1, content: "Glass Staircase with Aluminuim Railings & Accesories" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0008.jpg", id: 2, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0009.jpg", id: 3, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0010.jpg", id: 1, content: "Glass Staircase with Aluminuim Railings & Accesories" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0011.jpg", id: 2, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0012.jpg", id: 3, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0013.jpg", id: 1, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0014.jpg", id: 2, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0015.jpg", id: 3, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0016.jpg", id: 1, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0017.jpg", id: 2, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0018.jpg", id: 3, content: "Sliding doors" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0019.jpg", id: 1, content: "Sliding doors" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0020.jpg", id: 2, content: "Sliding doors" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0021.jpg", id: 3, content: "Balustrade" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0022.jpg", id: 1, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0023.jpg", id: 2, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0024.jpg", id: 3, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0025.jpg", id: 1, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0026.jpg", id: 2, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0027.jpg", id: 3, content: "Sliding doors" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0028.jpg", id: 1, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0029.jpg", id: 2, content: "Shower Doors" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0030.jpg", id: 3, content: "Sliding doors" },
        { img: imagesToSave["caseDataworksData0img"] || "/IMG-20250117-WA0031.jpg", id: 1, content: "Curtain wall" },
        { img: imagesToSave["caseDataworksData1img"] || "/IMG-20250117-WA0032.jpg", id: 2, content: "Curtain wall" },
        { img: imagesToSave["caseDataworksData2img"] || "/IMG-20250117-WA0033.jpg", id: 3, content: "Sliding doors" },
      ]
    },
    testimonyData: {
