                    ...
                    {consultantData.exp.map((ex: any, index: any) => (
                        <div key={index} className='xl:w-1/4 md:w-1/2 w-full text-center mt-14 px-3'>
                            <div className='relative'>
                                <div onClick={(e) => handleParentClick(e, index)} className='h-[19rem] flex items-center justify-center gap-3 w-full opacity-0 hover:opacity-100 transition-opacity duration-500 z-10 absolute bg-blue-700'>
